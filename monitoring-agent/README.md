...
> **Delivery:** Later — existing codebase; not the Phase 1 PRD target.  
> **Phase 1 agent:** [`../agent/`](../agent/) — see [`../docs/agent/prd.md`](../docs/agent/prd.md).  
> **Split ADR:** [`../docs/architecture/decisions/0007-two-vps-agents.md`](../docs/architecture/decisions/0007-two-vps-agents.md)
