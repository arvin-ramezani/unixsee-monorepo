...
import { WOOCOMMERCE_DESIGN_PAGE_NAV_ITEMS_KEYS } from "@/lib/constants";
...
export default function Page({}: PageProps) {
  const t = useTranslations(`Layout.WoocommerceDesignNavigation`);

  const sectionIds = WOOCOMMERCE_DESIGN_PAGE_NAV_ITEMS_KEYS.map((key) =>
    t(`${key}.href`),
  );
