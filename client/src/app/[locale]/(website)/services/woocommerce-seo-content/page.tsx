...
import { WOOCOMMERCE_SEO_CONTENT_PAGE_NAV_ITEMS_KEYS } from "@/lib/constants";
...
export default function Page({}: PageProps) {
  const t = useTranslations(`Layout.WoocommerceSeoContentNavigation`);

  const sectionIds = WOOCOMMERCE_SEO_CONTENT_PAGE_NAV_ITEMS_KEYS.map((key) =>
    t(`${key}.href`),
  );
