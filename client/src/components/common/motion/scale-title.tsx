  ...
  return (
    <MotionTag
      ...
      className={cn(
        "block",
        {
          "text-3xl font-extrabold md:text-4xl lg:text-[40px] rtl:leading-11 rtl:tracking-widest rtl:md:leading-12 rtl:lg:leading-14":
            as === "h2",
          "text-3xl font-extrabold md:text-4xl lg:text-[40px] rtl:tracking-widest":
            as !== "p",
          "text-text-secondary text-base md:text-lg lg:text-lg rtl:leading-7 rtl:md:leading-8 rtl:lg:leading-9":
            as === "p",
        },
        className,
      )}
