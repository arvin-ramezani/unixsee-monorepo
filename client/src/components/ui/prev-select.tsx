...
function Select({
  ...
  return (
    <SelectContext.Provider value={{ open, contentSide, setContentSide }}>
...
function SelectTrigger({
  ...
  const { open, contentSide } = useSelectContext();
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        open && contentSide === "bottom" && "rounded-b-none! border-b-0!",

        open && contentSide === "top" && "rounded-t-none! border-t-0!",

        open && contentSide === "left" && "rounded-s-none! border-s-0!",

        open && contentSide === "right" && "rounded-e-none! border-e-0!",
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-select-item-hover focus:text-accent-foreground not-data-[variant=destructive]:focus:**:text-accent-foreground relative flex w-full cursor-default items-center gap-1.5 rounded-md py-1 ps-8 pe-1.5 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className,
      )}
      {...props}
    >
