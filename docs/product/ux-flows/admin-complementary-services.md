...
- Explicit website management coverage governed by
...
- **BR-014 — Management coverage separation:** Managed and external websites are eligible for the four current families; request, quote, and assignment transitions never activate or change server-management coverage. Source: `website-management-coverage.md`. Status: Proposed.
...
### AC-014 — External website eligibility

**Given** a request targets an external website for one of the four current families, **when** authorized staff review, quote, or activate it, **then** no active Unixsee server plan is required, **and** the website's management coverage remains external.
