...
| E-005 | Tenant constraint     | `notes/customer-authorization-and-tenant.md` | Staff          | Commercial activation / assignment requires tenant shell; unauthorized uses confirm override (**1A**)                                                                  | Strong   | 2026-08-27 |
