...
Also respect [`docs/architecture/decisions/0003-ui-only-phase-boundaries.md`](./docs/architecture/decisions/0003-ui-only-phase-boundaries.md).
...
- Do not invent NestJS routes, DTOs, auth providers, database schemas, or
  payment contracts.
